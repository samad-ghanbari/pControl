...
?>
    <div style="width: 100%; max-width: 700px; margin: auto;">
        ...
        <h4 class="text-center text-primary">آمار استان</h4>
    </div>
...
<hr style="border-top: 1px dotted white;">
<div style="width:80%; margin:auto; background-color: whitesmoke;" class="">
...
<div style="width: 100%; max-width: 700px; margin: auto;">
    <?php if(empty($areas))
        ...
        echo '<h4 class="text-center text-primary">آمار مناطق</h4>';
    ?>
