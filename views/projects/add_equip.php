...
?>
    <p class="backicon">
        <a href="<?= Yii::$app->request->baseUrl.'/projects/edit_project?pid='.$project->id; ?>"><i class="fa fa-chevron-left fa-2x" style="color:white;position: relative;"></i></a>
    </p>
    ...
    <div class="topic-cover bg-gradient " >
        ...
        <?php
        $form = ActiveForm::begin(['action'=>Yii::$app->request->baseUrl."/projects/add_lom",
            'id'=>"lomForm",
