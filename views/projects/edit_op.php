...
<h4 style="text-align: center; color:white; direction:rtl;"> ویرایش عملیات / ویژگی </h4>
    ...
    <div class="col-md-8">
        <div style="width: 90%; max-width:700px; margin:auto; padding: 20px;" >
            ...
            $form = ActiveForm::begin([
                'action'=>Yii::$app->request->baseUrl."/projects/editop",
            ...
            <?= $form->field($model, 'op_weight', ['labelOptions'=>['style'=>'color:white;']])->textInput(['type'=>'number', 'min'=>0]); ?>
            <?= $form->field($model, 'priority', ['labelOptions'=>['style'=>'color:white;']])->textInput(['type'=>'number']); ?>
