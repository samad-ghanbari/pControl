...
<div class="row" style="width:100%">
    <div class="col-md-8">
        <div style="width: 90%; max-width:700px; margin:auto; padding: 20px;" >
            <h4 class="text-center" style="direction: rtl;color:white;">برای ایجاد کاربر جدید فرم زیر را تکمیل نمایید.</h4>
            <?php
            ...
            <div style="width:100%; clear:both;">
            <?= $form->field($model, 'enabled', ['options'=>['style'=>'float:right; width: 50%;'],'labelOptions'=>['style'=>'color:white;']])->dropDownList([1=>'فعال', 0=>' غیرفعال'] ); ?>
            <?= $form->field($model, 'tel', ['options'=>['style'=>'float:left; width: 50%;'],'labelOptions'=>['style'=>'color:white;']])->textInput(['placeholder' => "شماره تماس"]); ?>
            </div>
    ...
    <div class="col-md-4">
        <img src="<?= Yii::$app->request->baseUrl.'/web/images/user.png'; ?>" style="display: block;width:90%; max-width:600px;height:auto; margin:auto;">
    </div>
</div>
<br/>
</div>