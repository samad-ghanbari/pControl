...
<div class="layout-wrapper bg-gradient">
        ...
        <div class="layout-narrow-panel setting-sidebar">
            <?= \app\components\SidebarOwnerWidget::widget(['index'=>4, "projectId"=>$pId]); ?>
        </div>
        ...
        <div class="layout-wide-panel">
            ...
            <div style="width:95%; margin:auto;">
                ...
                $form = ActiveForm::begin([
                    'id'=>"projectsForm",
                    'method' => 'GET',
                    'action' => Yii::$app->request->baseUrl."/owner/project_users",
...
{
activateRow("row"+id);
$("#userContextModify").attr("href","$bPath/owner/edit_user_project?id="+id);
$("#userContextRemove").attr("href","$bPath/owner/remove_user_project?id="+id);
