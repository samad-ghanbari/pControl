...
<div class="layout-wrapper bg-gradient" >
    <div class="layout-narrow-panel setting-sidebar">
        <?= \app\components\SidebarOwnerWidget::widget(['index'=>1, "projectId"=>$pId]); ?>
    </div>
    ...
    <div class="layout-wide-panel">
        ...
        <div style="width:95%; margin:auto;">
            ...
            $form = ActiveForm::begin([
                'id'=>"projectsForm",
                'method' => 'GET',
                'action' => Yii::$app->request->baseUrl."/owner/edit_project",
            ...
            if($pId > -1)
            {
                ...
                <div style="width:95%; margin:auto;">
                    ...
                    $form = ActiveForm::begin([
                        'id'=>"addEquipForm",
                        'method'=>"POST",
                        'action' => Yii::$app->request->baseUrl.'/owner/lom_action',
                    ...
                    <br />
                    <?php ActiveForm::end(); ?>
                    <?= Html::a("فایل نمونه ورود LOM", ['owner/lom_template'] ,['style'=>"border-radius:0 8px 8px 0; direction:rtl;margin:0;float:right;", 'class' => 'btn btn-primary']) ?>
                    ...
                    <div style="display: flex; flex-wrap: wrap; justify-items: center;">
                        <?php
                        foreach ($lom as $LOM)
                            echo \app\components\LomWidget::widget(["model"=>$LOM, 'area'=>-1, 'edit'=>true, 'admin'=>false]);
                        ?>
                    </div>
