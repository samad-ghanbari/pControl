...
<div class="hvr-border-fade box-shadow-dark"  style="border-radius:5px;direction:rtl; width:300px;height:auto;background-color:whitesmoke;position: relative;float:right; margin: 10px;">
    ...
    <div class="enFont" style="position: relative; top:0; background-color:<?= $headercolor; ?>;border-radius:5px; color:white; height:40px;font-size: 14px; font-weight: bold; line-height:40px;" align="center">
        <?= $topicName; ?>
    </div>
    ...
    <div style="color:darkslateblue;padding:10px; height:200px; overflow: auto;">
        <table class="table table-hover">
            ...
            <!--LOM-->
            <?php
                foreach ($record['lom'] as $lom) { ?>
                    <tr>
                        <td class="enFont" style="color:darkslategray">
                            <?= $lom['equipment']; ?>
                        </td>
                        <td>
                            <?= $lom['quantity']; ?>
            ...
            <?php } ?>
            <tr>
                <td colspan="2" style="color:white; background-color: orange; text-align: center;"></td>
            </tr>
            ...
            foreach ($operations as $op)
            {
                ...
                {
                    $value = "";
                    if(isset($record[$op['operation']]['value']))
